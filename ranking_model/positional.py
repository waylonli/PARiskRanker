...
def _make_positional_encoding(d_model: int, positional_encoding_type, max_length=500):
    """
    ...
    if positional_encoding_type is None:
        ...
        return FixedPositionalEncoding(d_model, max_len=max_length)
    elif positional_encoding_type == "learned":
        return LearnedPositionalEncoding(d_model, max_len=max_length)
    else:
        raise ValueError("Invalid positional encoding type: {}".format(positional_encoding_type))
